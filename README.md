...
I'm a **Master's student in Information Security at Carnegie Mellon University** (graduating Dec 2026), with industry experience in **offensive security, vulnerability research, and security engineering**. My interests span **embedded systems**, hardware and firmware security, red teaming, RF/wireless sensing, cloud security, and application/API security.

I'm currently building **[wifisense](https://github.com/keyuraghao/wifisense)** - device-free WiFi RF sensing on an ESP32 mesh (see below).
...
| Project | What it is |
|---|---|
| [wifisense (research)](https://github.com/keyuraghao/wifisense) | Device-free WiFi RF sensing - detect motion/objects from ordinary WiFi RSSI, with an ESP32 mesh for 3D radio-tomographic imaging. Python pipeline + firmware for 6 ESP32 families. |
...
- **Embedded systems & RF sensing:** ESP32 firmware and a device-free WiFi sensing / radio-tomography mesh ([wifisense](https://github.com/keyuraghao/wifisense))
